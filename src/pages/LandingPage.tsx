...
const LandingPage = () => {
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-gray-600 dark:text-slate-300 font-medium transition-colors duration-300">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-700 dark:text-slate-300 leading-relaxed transition-colors duration-300">{step}</p>
                  </div>
                ))}
              </div>
            </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex flex-col md:flex-row items-center justify-between">
      ...
      <p className="text-gray-400 dark:text-slate-400 text-center transition-colors duration-300">
