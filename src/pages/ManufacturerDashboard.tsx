...
const ManufacturerDashboard = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {manufacturerRegisteredName ? (
                    <span>Welcome back, <span className="font-semibold text-emerald-600 dark:text-emerald-400">{manufacturerRegisteredName}</span>!</span>
                  ) : (
                ...
                <div>
                  ...
                  {!isManufacturerRegistered ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">You are successfully registered as a manufacturer.</p>
                    </div>
                  )}
                </div>
              )}
